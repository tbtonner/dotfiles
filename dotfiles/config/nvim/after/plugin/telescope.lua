...
vim.keymap.set("n", "gi", function() builtin.lsp_implementations(implementations) end, {})
vim.keymap.set("n", "gr", function() builtin.lsp_references({ initial_mode = "normal", show_line = false, include_current_line = false }) end, {})
